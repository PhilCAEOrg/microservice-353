 ...
 * 353 - Test Class
 *
 * This class provides a basic testing framework for the microservice 353. It was
...
public class todoTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(todo.class.getCanonicalName(),"0.1");

  private static final String mainPath = "todo";
  ...
  public void testtodos() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/todos", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testtodos': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
